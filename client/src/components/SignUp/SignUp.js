...
const SignUp = () => {
    return (
        <div className="container admin-login">
            ...
            <h2 className="text-center mb-3 display-4">SignUp</h2>
            <hr className='admin-title-line' />
            {/* <h1 className="text-center">Admin Login</h1> */}
            <form method="POST" action="/api/login">
                <div class="form-group">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="username" placeholder="Please enter your name" name="name" class="form-control" id="exampleInputEmail1"
                ...
                <button style={{ backgroundColor: '#1BCE7C', borderColor: '#1BCE7C', color: '#fff', padding: '5px'}} type="submit" class="btn btn-primary btn-lg btn-block mt-4">SignUp</button>
